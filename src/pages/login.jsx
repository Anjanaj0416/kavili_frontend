...
import { User, Phone, Eye, EyeOff, Mail } from 'lucide-react';
    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            if (result.success && result.user) {
                ...
                // Check if user exists with this email in backend
            ...
            if (error.response) {
                if (error.response.status === 404) {
                    toast.error('No account found with this Google email. Please register first or use traditional login.');
                } else {
                ...
                <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
                    ...
                    <div className="mb-6">
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-3 py-3 px-4 border-2 border-gray-300 rounded-lg font-medium text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {googleLoading ? (
                        ...
                        <p className="mt-2 text-xs text-gray-500 text-center">
                            For users who registered with Google email
                        </p>
                    </div>
                    ...
                    <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                        <p className="text-xs text-blue-600">
                            ...
                            1. Use Google sign-in if you registered with email<br />
                            2. Or enter your first name and phone number<br />
